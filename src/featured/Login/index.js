  ...
  return (
    <View style={styles.page}>
      <View style={styles.wrapper}>
        ...
        <Text style={styles.desc}>Sign to Continue</Text>
      </View>
      <Gap height={40} />
      <Input
        label={'Email'}
      ...
      />
      {formik.errors.email && formik.touched.email ? <Errors error={formik.errors.email} /> : null}
      <Gap height={16} />
      <Input
        label={'Password'}
        name={'password'}
      ...
      <Gap height={8} />
      <Link title="Forgot Password ?" position={'right'} size={Size.regular} />
      <Gap height={28} />
      {state.isLoading ? (
        <Button kind={'btnLoading'} />
      ) : (
